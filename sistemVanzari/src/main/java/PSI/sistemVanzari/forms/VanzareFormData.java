...
public class VanzareFormData {
	
	public static final String STORNARE = "Stornare";
	public static final String VANZARE_CU_AVIZ = "Vanzare cu Aviz";
	public static final String VANZARE_CU_FACTURA = "Vanzare cu factura";
	...
	public void setListaClientilor(List<Client> listaClientilor) {
		this.listaClientilor = listaClientilor;
	}
	...
	public List<String> getOperatiuni() {
		if (operatiuni == null)
		{
			...
			operatiuni.add(VANZARE_CU_AVIZ);
			operatiuni.add(VANZARE_CU_FACTURA);
